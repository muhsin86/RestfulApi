...
function fetchCourses() {
  fetch('http://localhost/PROCESS/webservice-master/src/model/courses.php', {
    method: 'GET'
  })
...
function fetchProjects() {
  fetch('http://localhost/PROCESS/webservice-master/src/model/projects.php', {
    method: 'GET'
  })
    .then(response => response.json())
    .then(projects => {
...
function fetchWorks() {
  fetch('http://localhost/PROCESS/webservice-master/src/model/works.php', {
    method: 'GET'
  })
    .then(response => response.json())
    .then(works => {
